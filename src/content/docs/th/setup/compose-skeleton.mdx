...
- เวอร์ชันเดียวกันเป๊ะ (`postgres:18`, `redis:8`) สำหรับ developer ทุกคน — ไม่มีปัญหา "เครื่องผมมี Postgres 14"
...
- `redis:8` ไม่ต้องการตัวแปร environment หรือ auth ใด ๆ สำหรับการพัฒนาบนเครื่อง local — ตรงกับ `REDIS_URL=redis://localhost:6379`
...
infra-db-1        postgres:18    Up 10 seconds (healthy)   0.0.0.0:5432->5432/tcp
infra-redis-1     redis:8        Up 10 seconds (healthy)   0.0.0.0:6379->6379/tcp
```
