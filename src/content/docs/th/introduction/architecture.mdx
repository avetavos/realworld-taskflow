...
ทุกตัวเลือกของสแตก — Rust/Axum, PostgreSQL, สามบทบาทของ Redis, Astro islands, WebSocket — คือการแลกเปลี่ยนที่ตั้งใจ และตอนนี้คุณอธิบายได้แล้ว ต่อไปเราจะไปตั้งค่าเครื่องของคุณใน [prerequisites](/taskflow/th/introduction/prerequisites/)
