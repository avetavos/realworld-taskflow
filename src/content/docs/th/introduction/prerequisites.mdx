...
Node รัน dev server และเครื่องมือ build ของ frontend ที่ทำด้วย Astro โดย TaskFlow ต้องการ **Node 20 ขึ้นไป** ติดตั้งผ่าน Homebrew (หรือ [nodejs.org](https://nodejs.org) หรือ version manager อย่าง `nvm`):
