...
- [ ] **Node 24+** — run the Astro frontend and its tooling
...
Node runs the Astro frontend's dev server and build tooling. TaskFlow needs **Node 24 or newer**. Install via Homebrew (or [nodejs.org](https://nodejs.org), or a version manager like `nvm`):
